- #interview/response
	- Web Security
		...
		- class-based deserialization attacks
			- It is common to transfer instances of objects between processes. This is commonly done in Java for distributed systems so that state can be passed easily between instances of the JVM. Allowing
	- Cloud Architecture
