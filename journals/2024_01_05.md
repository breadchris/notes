- #100DaysToOffload
  collapsed:: true
	- I have been putting together my resume today, and I noticed a problem with my personal site
	- ![Screenshot 2024-01-05 at 2.54.50 PM.png](../assets/Screenshot_2024-01-05_at_2.54.50 PM_1704495299729_0.png)
	- whups
	- Currently, my notes are hosted on [Github](https://github.com/breadchris/notes) and published with Pages. I just went through this repo and removed some random files that I had in there, but it looks like I also removed the generated site. This 404 isn't a surprise, very much par for the course when you are indiscriminately deleting files.
	- It just so happens that I have been recently adding a feature to LunaBrain so that I can generate a static Hugo site from it. It has been hard to determine what features to work on recently, I have been doing some experiments with rewriting parts of it (to much success!). But now that my personal site has some amount of importance (people looking at my resume might check it out) I have a discrete task to work on.
	- I like this [quote](https://arc.net/l/quote/dzchbxfz) from Paul Graham:
	- > I like debugging: it's the one time that hacking is as straightforward as people think it is.
	- While the debugging didn't take long, there is the action of fixing this problem that I have to solve now. With the urgency of a deadline (I want to apply to companies) I am more inclined to hack something together to get this work rather than opting for the scope creep state of mind.
	- Oh yeah, and I want these posts to be automatically posted to my site. It isn't much code to make it happen, but focus! I must focus!
	- Let's see what I come up with! More tomorrow, hopefully :)
- #ai/learn
  collapsed:: true
...
- #lunabrain/work
	...
	- manually moved content over to blog
		- this was helpful to see what features I will use when generating content via lunabrain
- #jobs/search
  collapsed:: true
